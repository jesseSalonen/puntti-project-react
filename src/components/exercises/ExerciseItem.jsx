...
const ExerciseItem = ({exercise, onDelete, onAddToWorkout}) => {
  ...
  return (
    <div
      className="mb-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
      <div className="flex flex-col">
        ...
        <div className="mt-2 flex flex-wrap gap-2">
          {typeof onAddToWorkout === 'function' ? (
            <button
              type="button"
