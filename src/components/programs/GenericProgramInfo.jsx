...
import {FaAlignLeft, FaDumbbell, FaEdit} from 'react-icons/fa';

const GenericProgramInfo = ({ setName, name, setDescription, description }) => {
  const { t } = useTranslation("dashboard", "programs");
    ...
    <div className="mb-6 rounded-lg border border-gray-200 bg-white shadow-sm transition-all hover:shadow-md dark:border-gray-700 dark:bg-gray-800 overflow-hidden">
      <div className="p-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
        <div className="flex items-center">
          ...
          <h3 className="text-xl font-bold">{t("programInfo", {ns: "programs"})}</h3>
        </div>
      </div>
        ...
        <div className="mb-5">
          ...
          <div className="relative group">
            ...
            <input
              ...
              name="name"
              id="name"
              placeholder={t("enterProgramName", {ns: "programs"})}
              value={name}
              required
        ...
        <div>
          ...
          <div className="relative group">
            ...
            <textarea
              ...
              id="description"
              rows="4"
              placeholder={t("enterProgramDesc" , {ns: "programs"})}
              value={description}
...
export default GenericProgramInfo;